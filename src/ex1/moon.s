...
SPRITE2: .byte \
  ...
  %00001111,%11111000,%00000000, \
  %00011111,%11110000,%00000000, \
  %00111111,%11110000,%00000000, \
...
.proc TASK3
    ...
    ldx #62         ;copy sprite
:   lda SPRITE2,x
    sta $6840,x     ;to trzeba by wyliczyć z TEXPAGE+(SHAPENR<<6)
    dex
    bpl :-
    ldx #SPRITENR   ;X = sprit number
    lda #SHAPENR    ;kształt pod adresem $2840 w ramach VIC
